...
const isWeapon = (s: VehicleModuleFormState) =>
  s.type === "pilot_module_weapon";
const isArmor = (s: VehicleModuleFormState) => s.type === "pilot_module_armor";
const isSupport = (s: VehicleModuleFormState) =>
  s.type === "pilot_module_support";
...
export const vehicleModuleFieldConfig: ItemFieldConfig<VehicleModuleFormState> =
  [
    ...
    ...(metaFieldConfigWithGroup(
      G.source,
    ) as unknown as ItemFieldConfig<VehicleModuleFormState>),
  ];
