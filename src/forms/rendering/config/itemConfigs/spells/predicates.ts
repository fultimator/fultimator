...
export const isTherioform = (s: PlayerSpellFormState) => s.spellType === "therioform";
export const isMagichantKey = (s: PlayerSpellFormState) => s.spellType === "magichant-key";
export const isMagichantTone = (s: PlayerSpellFormState) => s.spellType === "magichant";
export const isSymbol = (s: PlayerSpellFormState) => s.spellType === "symbol";
export const isInvocation = (s: PlayerSpellFormState) => s.spellType === "invocation";
export const isCooking = (s: PlayerSpellFormState) => s.spellType === "cooking";
export const isMagiseed = (s: PlayerSpellFormState) => s.spellType === "magiseed";
