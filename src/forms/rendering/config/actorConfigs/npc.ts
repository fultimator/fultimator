...
export const npcFieldConfig: ItemFieldConfig<NpcFormState> = [
  // basics
  {
    ...
    group: "basics",
    order: 0,
    gridSize: { xs: 12, sm: 5 } as unknown as number,
  ...
  },
  {
    ...
    group: "basics",
    order: 1,
    gridSize: { xs: 12, sm: 7 } as unknown as number,
  },
  {
    key: "species",
    kind: "editable",
  ...
  },
  {
    ...
    group: "basics",
    order: 6,
    gridSize: { xs: 12, sm: 9 } as unknown as number,
  ...
  },
  {
    ...
    group: "basics",
    order: 6,
    gridSize: { xs: 6, sm: 6 } as unknown as number,
