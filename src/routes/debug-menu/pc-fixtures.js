export const SAMPLE_PC = {
  ...
  classes: [
    {
      ...
      heroic: {
        fuid: "upgrade",
        description:
          "When you rest, you may choose any number of weapons, armor, and/or shields among those owned by your group.",
        name: "Upgrade",
      },
      skills: [
        {
      ...
      spells: [
        {
          ...
          special: [],
          cost: { perTarget: true, amount: 10, resource: "mp" },
          spellType: "default",
          duration: "Instantaneous",
          description:
            "You invigorate your companions, soothing their pain and healing their fatigue. Each target recovers 40 Hit Points.",
          damage: { hrZero: false, type: "physical", value: 0 },
        },
        {
          fuid: "reinforce",
          special: [],
          targetDescription: "Up to three creatures",
          damage: { type: "physical", hrZero: false, value: 0 },
          description:
        ...
        },
        {
          ...
          damage: { hrZero: false, type: "physical", value: 0 },
          cost: { perTarget: true, resource: "mp", amount: 10 },
          spellType: "default",
          special: [],
      ...
      benefits: {
        ...
        martials: { melee: false, ranged: false, shields: false, armor: false },
      },
    },
    {
      fuid: "pilot",
      ...
      benefits: {
        ...
        isCustomBenefit: false,
        martials: { melee: true, shields: false, ranged: true, armor: false },
      },
      isHomebrew: false,
      lvl: 10,
      skills: [
    ...
    },
    {
      ...
      heroic: {
        fuid: "mathemagic",
        description:
          "When you cast a spell with a target of One creature, you may choose an Attribute and a die size.",
        name: "Mathemagic",
      },
      skills: [
        {
      ...
      benefits: {
        ...
        hpplus: 0,
        spellClasses: [],
        martials: { melee: false, shields: false, ranged: false, armor: false },
      },
    },
    {
      fuid: "wayfarer",
      ...
      benefits: {
        ...
        ipplus: 2,
        rituals: { ritualism: false },
        martials: { melee: false, shields: false, armor: false, ranged: false },
        isCustomBenefit: false,
        hpplus: 0,
        spellClasses: [],
      },
      ...
      heroic: {
        fuid: "extra-spells",
        name: "Extra Spells",
        description: "Elementalist: Fulgur and Thunderbolt",
      },
      name: "Wayfarer",
    },
    {
      ...
      heroic: {
        fuid: "tempest-strike",
        description:
          "When you perform a melee attack with the multi property, you gain a bonus to your Accuracy Check.",
        name: "Tempest Strike",
      },
      benefits: {
        rituals: { ritualism: false },
        ipplus: 0,
        mpplus: 0,
        martials: { melee: true, armor: false, ranged: false, shields: true },
        isCustomBenefit: false,
        spellClasses: [],
        hpplus: 5,
      },
  ...
  info: {
    ...
    theme: "Guilt",
    pronouns: "He/him",
    identity: "Magitech Engineer",
    description:
      "Pellentesque elementum sed lacus ut aliquam maximus vel proin lorem sollicitudin maximus vivamus condimentum nisl lacus adipiscing nulla amet consectetur amet eu adipiscing felis nec.\n\nEget maecenas nec interdum tincidunt commodo nec pellentesque nisi commodo sollicitudin maximus et maximus arcu elit quisque nulla phasellus maximus arcu adipiscing molestie diam morbi.",
    fabulapoints: 4,
    origin: "Neo-Babylon",
    zenit: 370,
  ...
  notes: [
    {
      ...
      description:
        "Bibendum elementum molestie ac commodo erat sem porta est congue sed gravida condimentum sit arcu suspendisse sem facilisis ex quisque gravida commodo amet scelerisque elit facilisis.\n\nLacus metus molestie suspendisse tortor tincidunt magna pellentesque elementum eros nec ipsum morbi sem tempus congue.",
      clocks: [
        { name: "Infiltrate", sections: 4, state: [true, true, false, false] },
      ],
    },
    {
      name: "Rumor: Ancient Arcanum",
      description:
        "Bibendum elementum molestie ac commodo erat sem porta est congue sed gravida condimentum sit arcu suspendisse.",
      clocks: [
        {
          name: "Track Merchant",
          sections: 6,
  ...
  vehicleSlots: {
    ...
    offHand: {
      vehicleName: "Magitek Armor",
      moduleName: "pilot_module_cannon",
    },
    armor: {
      vehicleName: "Magitek Armor",
      moduleName: "pilot_module_standard_plating",
    },
    accessory: null,
    support: [
      {
        vehicleName: "Magitek Armor",
        moduleName: "pilot_module_secondary_offensive",
      },
    ],
  },
  modifiers: {
  ...
  published: false,
  stats: {
    hp: { max: 110, current: 110 },
    ip: { max: 10, current: 10 },
    mp: { max: 110, current: 110 },
  },
  equipment: [
    {
      shields: [
      ...
      accessories: [
        {
          quality:
            "Commodo phasellus vivamus varius sem morbi tincidunt suspendisse nec nulla urna ex metus ex bibendum metus tristique tortor accumsan lorem bibendum diam elementum gravida phasellus.",
      ...
      customWeapons: [
        {
          name: "Switchblade",
          fuid: "switchblade",
          category: "weapon_category_sword",
          range: "melee",
          customizations: [
            {
          ...
          qualityCost: 1000,
          selectedQuality: "Dual Resistance",
          cost: 1700,
          hands: 2,
          martial: false,
          secondAccuracy: {
          ...
          secondDamage: { value: 11, type: "physical", hrZero: false },
          ...
          secondSelectedCategory: "weapon_category_bow",
