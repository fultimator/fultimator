import {Badge, Button, Divider, Grid, IconButton, TextField} from "@mui/material";
import {AddCircleOutline, Close, RemoveCircleOutline, SouthEast, SouthWest} from "@mui/icons-material";
...
export default function PrepareRoll({savePreparedRoll, createRoll}) {
  ...
  const onRoll = useCallback(() => {
    const {dice, modifier} = prepareDice(d4, d6, d8, d10, d12, d20, bonus, malus);
  ...
  >
    <Grid item>
      <IconButton sx={{fontSize: "4rem", color: "primary.main"}}
                  onContextMenu={onLower(setd4)}
                  onClick={onRaise(setd4)}>
        <Badge badgeContent={d4} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
          <D4Icon/>
        </Badge>
      </IconButton>
    </Grid>
    <Grid item>
      <IconButton sx={{fontSize: "4rem", color: "primary.main"}}
        ...
        <Badge badgeContent={d6} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
          <D6Icon/>
        </Badge>
      </IconButton>
    </Grid>
    <Grid item>
      <IconButton sx={{fontSize: "4rem", color: "primary.main"}}
        ...
        <Badge badgeContent={d8} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
          <D8Icon/>
        </Badge>
      </IconButton>
    </Grid>
    <Grid item>
      <IconButton sx={{fontSize: "4rem", color: "primary.main"}}
        ...
        <Badge badgeContent={d10} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
          <D10Icon/>
        </Badge>
      </IconButton>
    </Grid>
    <Grid item>
      <IconButton sx={{fontSize: "4rem", color: "primary.main"}}
        ...
        <Badge badgeContent={d12} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
          <D12Icon/>
        </Badge>
      </IconButton>
    </Grid>
    <Grid item>
      <IconButton sx={{fontSize: "4rem", color: "primary.main"}}
        ...
        <Badge badgeContent={d20} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
          <D20Icon/>
        </Badge>
      </IconButton>
    </Grid>
    ...
    <Grid item>
      <IconButton sx={{color: "primary.main"}}
        ...
        <Badge badgeContent={bonus} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
          <AddCircleOutline sx={{fontSize: "4rem"}}/></Badge>
      </IconButton>
    </Grid>
    <Grid item>
      <IconButton sx={{color: "primary.main"}}
        ...
        <Badge badgeContent={malus} color="secondary" sx={{"& .MuiBadge-badge": {fontSize: "1.2rem"}}}>
