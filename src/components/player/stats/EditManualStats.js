...
export default function EditManualStats({
  ...
  }, [hpModifier, mpModifier, ipModifier, defModifier, mdefModifier, initModifier]);
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={4}>
          <TextField
            ...
            color={hpModifier >0 ? "success" : hpModifier < 0 ? "error" : "primary"}
        ...
        <Grid item xs={4}>
          <TextField
            ...
            color={mpModifier > 0 ? "success" : mpModifier < 0 ? "error" : "primary"}
        ...
        <Grid item xs={4}>
          <TextField
            ...
            color={ipModifier > 0 ? "success" : ipModifier < 0 ? "error" : "primary"}
        ...
        <Grid item xs={4}>
          <TextField
            ...
            color={defModifier > 0 ? "success" : defModifier < 0 ? "error" : "primary"}
        ...
        <Grid item xs={4}>
          <TextField
            ...
            color={mdefModifier > 0 ? "success" : mdefModifier < 0 ? "error" : "primary"}
        ...
        <Grid item xs={4}>
          <TextField
            ...
            color={initModifier > 0 ? "success" : initModifier < 0 ? "error" : "primary"}
