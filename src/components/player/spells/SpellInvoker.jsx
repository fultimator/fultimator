            ...
            {[
              ...
              return (
                <Chip
                  ...
                  disabled={!isEditMode}
                  onClick={
                    isInnerWellspring || !isEditMode
                      ? undefined
                      : () =>
                          onWellspringToggle &&
                          onWellspringToggle(wellspring.name)
                  }
                  variant={
                    isActive || isInnerWellspring ? "filled" : "outlined"
                  }
                  sx={{
                    backgroundColor:
                    ...
                    fontWeight:
                      isActive || isInnerWellspring ? "bold" : "normal",
                    cursor:
                      isInnerWellspring || !isEditMode ? "default" : "pointer",
                    "& .MuiChip-label": {
                      color:
                        isActive || isInnerWellspring
                          ? `${selectedTextColor} !important`
