      ...
      <Grid container spacing={1}>
        <Grid size={12}>
          <CustomHeader
            ...
            icon={AddIcon}
            customTooltip={t("Add Zero Power")}
          />
        </Grid>
              ...
              >
                    ...
                    <MenuItem
                      onClick={async () => {
                        ...
                        await addItem(pack.id, "optional", {
                          subtype: "zero-power",
                          name: zeroPower.name || "",
                          zeroTrigger: zeroPower.zeroTrigger || {
                            name: "",
                            description: "",
                          },
                          zeroEffect: zeroPower.zeroEffect || {
                            name: "",
                            description: "",
                          },
                          zeroTriggerRef: "",
                ...
                <Box sx={{ flexGrow: 1, minWidth: 0 }}>
                  <Typography noWrap sx={{ fontWeight: 700 }}>
                    {zeroPower.name || t("Unnamed Zero Power")}
                  </Typography>
                </Box>
