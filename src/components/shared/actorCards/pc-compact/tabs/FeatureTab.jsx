...
import DefaultSpellSection from "../../../../player/spells/sections/DefaultSpellSection";
import ArcanistGeneralSection from "../../../../player/spells/sections/ArcanistGeneralSection";
import GeneralSection from "../../../../player/spells/sections/GeneralSection";
import MagiseedGeneralSection from "../../../../player/spells/sections/MagiseedGeneralSection";
import MagiseedContentSection from "../../../../player/spells/sections/MagiseedContentSection";
import GiftContentSection from "../../../../player/spells/sections/GiftContentSection";
import DancerContentSection from "../../../../player/spells/sections/DancerContentSection";
import SymbolistContentSection from "../../../../player/spells/sections/SymbolistContentSection";
...
import MutantContentSection from "../../../../player/spells/sections/MutantContentSection";
import PilotGeneralSection from "../../../../player/spells/sections/PilotGeneralSection";
import PilotContentSection from "../../../../player/spells/sections/PilotContentSection";
import InvokerGeneralSection from "../../../../player/spells/sections/InvokerGeneralSection";
import InvokerContentSection from "../../../../player/spells/sections/InvokerContentSection";
import GourmetGeneralSection from "../../../../player/spells/sections/GourmetGeneralSection";
import GourmetContentSection from "../../../../player/spells/sections/GourmetContentSection";
import GourmetInventoryTab from "../../../../player/spells/sections/GourmetInventoryTab";
import GourmetCookingTab from "../../../../player/spells/sections/GourmetCookingTab";
import GambleGeneralSection from "../../../../player/spells/sections/GambleGeneralSection";
import CompendiumViewerModal from "../../../../compendium/CompendiumViewerModal";
import SpellTinkererMagitechRankModal from "../../../../player/spells/SpellTinkererMagitechRankModal";
import { getSlottedMnemospheres } from "../../../../player/classes/mnemosphereClassUtils";
import classList, {
  tinkererAlchemy,
  tinkererInfusion,
} from "../../../../../libs/classes";
import PcCompactQuirk from "../panels/PcCompactQuirk";
import PcCompactCampActivities from "../panels/PcCompactCampActivities";
import PcCompactZeroPower from "../panels/PcCompactZeroPower";
import PcCompactOthers from "../panels/PcCompactOthers";
import PcCompactRituals from "../panels/PcCompactRituals";
...
function VehicleCard({
  ...
  return (
    <Box
      onClick={() => hasModules && setOpen((v) => !v)}
      sx={{
        border: "1px solid",
        borderColor: isActive ? theme.primary : "divider",
          ...
          <Tooltip title={isActive ? t("Active") : t("Activate")} arrow>
            <IconButton
              ...
              sx={{
                ...
                width: 28,
                height: 28,
                color: isActive ? theme.primary : "text.disabled",
              }}
              onClick={handleActivate}
            >
              <RadioButtonChecked sx={{ fontSize: "1.15rem" }} />
            </IconButton>
          </Tooltip>
        </Box>
      </Box>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box
          sx={{ display: "flex", alignItems: "center", flexShrink: 0, gap: 0 }}
          onClick={(e) => e.stopPropagation()}
        >
          {isOffensive && (
      ...
      {/* Expanded spell content */}
      {open && (
        <Box sx={{ px: 1, pb: 1 }}>
          {renderSpellContent(spell, setPlayer, searchQuery)}
        </Box>
      )}
    </Box>
  );
    ...
    <Box onClick={() => setOpen((v) => !v)} sx={{ cursor: "pointer" }}>
      ...
      {open && (
        ...
        >
          ...
          >
            <NotesMarkdown compact fontSize="0.85rem">
              {t(spell.description || "")}
            </NotesMarkdown>
          </Box>
        </Box>
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column" }}>
      ...
      {optionalRules.quirks && (
        <PcCompactQuirk player={player} setPlayer={setPlayer} searchQuery={searchQuery} />
      )}
