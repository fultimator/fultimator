...
import { AffinityStrip, AffinityCell } from "../../pc/shared";
import { AFFINITY_TYPES } from "../../core-utils";

export default function PcCompactAffinities({ pc, isInteractive = false, onUpdate }) {
  ...
  return (
    <Box sx={{ containerType: "inline-size", containerName: "compact-affinity-strip", width: "100%" }}>
      <AffinityStrip
        sx={{
        ...
        {AFFINITY_TYPES.map((type) => (
          <AffinityCell
            ...
            sx={{
              ...
              ...(isInteractive ? {
                minHeight: 32,
                "& .MuiButtonBase-root": { minHeight: 26, px: 0.35, py: 0, gap: 0.35 },
                "& .MuiButtonBase-root .MuiTypography-root": { fontSize: "0.88rem !important" },
                "& .MuiButtonBase-root .MuiSvgIcon-root": { fontSize: "0.82rem !important" },
              } : {}),
            }}
          >
            {isInteractive ? (
