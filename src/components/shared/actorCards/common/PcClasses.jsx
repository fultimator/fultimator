...
import EditPlayerClassModal from "../../../player/classes/EditPlayerClassModal";
...
} from "../../../player/classes/classLevelUtils";
import useSphereBank from "../../../player/equipment/technospheres/useSphereBank";
...
export default function PcClasses({
  ...
  if (!pc?.classes?.length) return null;
